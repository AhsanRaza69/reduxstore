...
const Navbar = () => {
  ...
  return (  
    <div className='fixed w-full  z-20'>
        <div className={ `px-2  min-h-[100px]  items-center flex justify-between lg:px-16 py-8  ${
        scrollBackground ? 'bg-white text-gray-600' : ' bg-tansparent text-white  '
      } transition-all duration-300 `    }>
        <div>
           <Link to='/'>
            <img className='w-[140px] lg:w-full ' 
            src={`${
    ...
    <div className='flex gap-2 text-lg md:text-2xl cursor-pointer '>
      ...
      {
        Nav && (
             <ul  className='w-[70%]   h-screen flex items-center flex-col pl-4 pt-16 top-0 ease-linear transition-transform duration-300  right-0  absolute  bg-black  text-white'>
